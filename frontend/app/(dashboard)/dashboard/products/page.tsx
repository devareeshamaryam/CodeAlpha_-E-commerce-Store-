    ...
    <div className="p-8 max-w-[1100px]">
      ...
      <div className="grid grid-cols-3 gap-4 mb-8">
        {[
          ...
          { label: "Active Listings", value: filtered.length },
          ...
          <tbody>
            {loading ? (
              ...
              filtered.map((product, i) => (
                <tr key={product.id}
                  className={`border-b border-[#f2f2f2] hover:bg-[#fafafa] transition-colors ${i === filtered.length - 1 ? "border-b-0" : ""}`}>
                  <td className="px-5 py-4">
                    <div className="flex items-center gap-4">
                      <div className="relative w-12 h-12 bg-[#f2f2f2] rounded-sm flex-shrink-0 overflow-hidden">
                        <Image src={product.image || "/images/placeholder.png"} alt={product.name} fill sizes="48px" className="object-contain p-1.5" />
                      </div>
                      <div>
